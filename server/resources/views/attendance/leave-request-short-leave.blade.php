...
<head>
    ...
    <title> Template Welcome Email</title>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="padding: 10px 0px;">
                ...
                <p style="line-height: 15px; font-size: 17px;"><strong style="font-weight: 600">Leave Dates:</strong>{{$start}}</p>
                <p style="line-height: 15px; font-size: 17px;"><strong style="font-weight: 600">Time:</strong>{{$start_time}}</p>
