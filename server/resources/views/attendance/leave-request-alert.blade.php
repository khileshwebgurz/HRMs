...
<td valign="top" style="background-image: url(https://webguruz.in/hrm/leave-template/leave-request-image.png); background-repeat: no-repeat; background-position: center;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="padding: 10px 0px;">
                <p style="line-height: 15px; font-size: 17px;"><strong style="font-weight: 600">{{$employee}}</strong> has applied for a Leave.</p>
                ...
                <p style="line-height: 15px; font-size: 17px;"><strong style="font-weight: 600">No of Days:</strong>{{$total_applied_leaves}}</p>
                <p style="line-height: 15px; font-size: 17px;"><strong style="font-weight: 600;">Reason for Leave:</strong> {{$reason}}</p>
                <p style="line-height: 15px; font-size: 17px;">Please click on link to approve / reject the application.</p>
            </td>
        </tr>
        <tr>
            <td align="center" style="padding: 0 0 20px 0">
                <a href="{{$approve}}" style="display: inline-block;padding: 8px 10px;font-size: 15px;background: #26c6da;color: #fff;margin: 0 2px;font-weight: bold;border-radius: 4px;">Approve</a>                                                        
                <a href="{{$reject}}" style="display: inline-block;padding: 8px 10px;font-size: 15px;background: #001e36;color: #fff;margin: 0 2px;font-weight: bold;border-radius: 4px;">Reject</a>
                <a href="{{$view}}" style="display: inline-block;padding: 8px 10px;font-size: 15px;background: #001e36;color: #fff;margin: 0 2px;font-weight: bold;border-radius: 4px;">View Details</a>
