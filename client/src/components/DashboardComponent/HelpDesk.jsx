...
const HelpDesk = () => {
    ...
    const fetchResults = async () => {
      try {
        const res = await axios.post(
          `${import.meta.env.VITE_API_BASE_URL}/helpdesk/query`,{ search: query }, 
          {
  ...
  console.log('my helpdesk data is >>> ',results);
  return (
    <>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="helpDesk-card">
                ...
                <div
                  className={`form-outline helpDesk-search ${
                    query ? "show" : ""
                  }`}
                >
                  <input
